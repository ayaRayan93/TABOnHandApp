...
public class CustomerInvoiceContentProvider extends ContentProvider {
    // database
    private DataBaseHelper database;//=CustomerContentProvider.database;
    private Context context;
    // used for the UriMacher
    public CustomerInvoiceContentProvider() {

    }
    public CustomerInvoiceContentProvider(DataBaseHelper database) {
        this.database=database;
    }
    public CustomerInvoiceContentProvider(Context context) {
    ...
    private static final String BASE_PATH = "CustomerInvoice";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        // Set the table
        queryBuilder.setTables(CustomerInvoiceTable.CustomerInvoiceTable);
...
//        cursor.setNotificationUri(getContext().getContentResolver(), uri);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long id = 0;
        try {
            id = sqlDB.insert(CustomerInvoiceTable.CustomerInvoiceTable, null, values);
        }
        catch(Exception e){
            throw new IllegalArgumentException("Unknown URI: " + uri);
        }
